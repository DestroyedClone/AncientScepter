...
namespace AncientScepter.Modules.Skills
{
    public class ToolbotDash2 : ScepterSkill
    {
        ...
        internal override void SetupAttributes()
        {
            ...
            baseSkillDef.icon = Assets.SpriteAssets.ToolbotDash2;
        ...
        {
            BetterUI.ProcCoefficientCatalog.AddSkill(baseSkillDef.skillName, BetterUI.ProcCoefficientCatalog.GetProcCoefficientInfo("ToolbotBodyToolbotDash"));
            BetterUI.ProcCoefficientCatalog.AddToSkill(baseSkillDef.skillName, "Explosion", 1f);
        }
