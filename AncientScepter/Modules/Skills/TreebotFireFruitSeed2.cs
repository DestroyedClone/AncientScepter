        ...
        private void GlobalEventManager_onCharacterDeathGlobal(DamageReport damageReport)
        {
            ...
            if (damageReport.attackerBody && damageReport.attackerBody.skillLocator.GetSkill(targetSlot)?.skillDef == skillDefToClone)
            {
                ...
                if (victimBody.HasBuff(RoR2Content.Buffs.Fruiting) || (damageReport.damageInfo.damageType & DamageType.FruitOnHit) > DamageType.Generic)
                {
                    ...
                    {
                        GameObject gameObject4 = UnityEngine.Object.Instantiate(ScepterTreebotFruitPackPrefab, gameObject.transform.position + UnityEngine.Random.insideUnitSphere * victimBody.radius * 0.5f, UnityEngine.Random.rotation);
