...
namespace AncientScepter
{
    ...
    public static class SkillUtil
    {
        ...
        public static DrifterSkillDef CloneDrifterSkillDef(DrifterSkillDef oldDef, Sprite overrideIcon)
        {
            var newDef = ScriptableObject.CreateInstance<DrifterSkillDef>();
            ...
            newDef.requireJunkForActivation = oldDef.requireJunkForActivation;
            newDef.bypassCooldown = oldDef.bypassCooldown;
            newDef.overrideIcon = overrideIcon;

            newDef.enableMagicBagDisplay = oldDef.enableMagicBagDisplay;
            newDef.projectileFamily = oldDef.projectileFamily;
